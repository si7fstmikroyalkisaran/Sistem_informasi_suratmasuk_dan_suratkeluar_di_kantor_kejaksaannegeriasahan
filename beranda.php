    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-success">
                <strong><marquee bgcolor="blue", behavior="alternate", scrollamount="12">Selamat Datang di SI Surat Masuk Dan Surat keluar Di Kejaksaan Negeri Asahan</marquee></strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-3 col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Welcome <?=$_SESSION['tanggal']?></strong>
            </div>
            <?php
           } else { ?>
